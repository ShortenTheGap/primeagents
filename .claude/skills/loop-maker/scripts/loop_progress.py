...
Pure stdlib, prints to stdout. Optional: if python3 is not on PATH the wizard
hand-draws the same boxes. The single Python pass is faster and never miscounts
box-drawing cells. (Once the desk's Loops panel ships, it renders these natively.)
"""
